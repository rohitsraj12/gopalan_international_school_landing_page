<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $subject = "NIOS Brochure Form | GIS Landing Page";
        $message = "<p>NIOS Brochure form</p></br>";
        ...
        header("location:https://www.gopalanschool.com/international/pdf/NIOS-brochure.pdf");
    }